class GitWt < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/ahmedelgabri/git-wt/releases/download/v2.1.0/git-wt-2.1.0-darwin-amd64.tar.gz"
      sha256 "2380e18b1a9db696f32482c2de7edb84bea48ec3e53f721037bc2b99826311e0"
    end

    on_arm do
      url "https://github.com/ahmedelgabri/git-wt/releases/download/v2.1.0/git-wt-2.1.0-darwin-arm64.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/ahmedelgabri/git-wt/releases/download/v2.1.0/git-wt-2.1.0-linux-amd64.tar.gz"
      sha256 "4dc7dd5cbf6ae0a2722b7e234cefbebb4250621e4d8d6bfd1b1407d71c348d63"
    end

    on_arm do
      url "https://github.com/ahmedelgabri/git-wt/releases/download/v2.1.0/git-wt-2.1.0-linux-arm64.tar.gz"
